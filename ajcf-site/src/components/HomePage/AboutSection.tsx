...
export const AboutSection = () => {
  return (
    <section id="about" style={style}>
      ...
      <p>
        Créée en 2009, l’Association des jeunes chinois de France (AJCF) est une association à but non lucratif (loi du
        1er juillet 1901) qui a pour objet de :
        ...
        Permettre à la société française d’approfondir sa connaissance de la culture chinoise et de ses représentants en
        France ; Lutter contre le racisme anti-asiatique et venir en aide aux victimes.
      </p>
      <h1>L'histoire de l'AJCF</h1>
      <p>
        L’AJCF est avant tout une histoire, celle d’une jeunesse issue de cette France nouvelle : diversité culturelle,
        engagement citoyen, échanges libres sur les réseaux sociaux.
        <br />
      ...
      <p>
        ...
        <br />
        Aujourd’hui, l’association organise des débats et des conférences autour de thèmes en rapport avec la communauté
        chinoise de France et les interactions franco-chinoises, des séances d’échange linguistique franco-chinois, des
        ateliers de développement individuel, mais aussi des dîners destinés à faire découvrir la richesse de la
      ...
      <p>
        ...
        journalistes, sociologues, historiens, chercheurs, employés, artisans, entrepreneurs, étudiants, amoureux de la
        Chine etc.
        <br />
        Son évolution a montré que ses membres et amis ne se retrouvaient pas à travers un lieu de naissance ou des
        origines communes, mais à travers des valeurs, des histoires, des aspirations, des vécus, des déceptions ou des
        succès partagés dans un cadre ouvert, ayant pour toile de fond une meilleure compréhension de l’immigration
        chinoise en France, de la culture chinoise et de la Chine contemporaine.
      </p>
      <Bureau />
    </section>
  );
