export const subscriptionReminderMail = (firstName: string) => `<p>Bienvenue ${firstName},</p>
...
<ol>
    ...
    <li>bénéficier de la priorité pour l&#39;inscription aux événements</li>
...
<p>Merci pour ton soutien et à très bientôt 💟</p>
<p>L&#39;équipe AJCF </p>
<p>PS : petit rappel de tous nos projets dans le fichier en pièce jointe 😉 </p>
<p><img src="https://ajcf-videos.s3-eu-west-1.amazonaws.com/ajcf-logo.jpg" alt="Logo AJCF" style="width: 50px"></p>
`;
